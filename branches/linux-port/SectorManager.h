...
private:
	...
	TimeNodeVec		m_LongTermTimeNodes;	// used for longer term time nodes

    TimeNodeVec		m_EventSlotHead[TIMESLOT_DURATION*10]; //1 per 100ms
...
#ifdef WIN32
	HANDLE			m_SectorManagerThreadHandle;
#else
	pthread_t		m_SectorManagerThreadHandle;
#endif
};
