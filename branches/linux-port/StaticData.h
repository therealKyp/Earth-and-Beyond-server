...
static int BaseSpeed[] =        {159,  155,  170,  137,  159,  177,  124,  137,  137};
   ...
   static const char * BaseShield[] =    {"Repulsion Field Generator", "Reflection Field Generator", "Absorption Field Generator"};
   static const char * BaseReactor[] =   {"Terran Chemical Reactor", "Jenquai Compression Reactor", "Progen Radium Reactor"};
   static const char * BaseEngine[] =    {"InfinitiCorp XR-24-36-G", "Compression Thrusters", "Chemical Thrusters"};
   static const char * BaseWeapon[] =    {"Gradient Laser", "Pulse Laser", "Diamond Laser"};
#else
   static const char * BaseShield[] =    {"Repulsion Field Generator", "Reflection Field Generator", "Absorption Field Generator"};
   static const char * BaseReactor[] =   {"Terran Chemical Reactor", "Jenquai Compression Reactor", "Projen Chemical Reactor"};
   static const char * BaseEngine[] =    {"XR-24-36-G", "Compression Thrusters", "Chemical Thrusters"};
   static const char * BaseWeapon[] =    {"Gradient Laser", "Pulse Laser", "Diamond Laser"};
#endif
