...
public:
    ...
    sql_var_c operator [] (const char *name); //USE SPARINGLY
...
public:
    ...
    void AddData(const char *Field, int Value);
    void AddData(const char *Field, unsigned long Value);
    void AddData(const char *Field, unsigned int Value);
    void AddData(const char *Field, long Value);
    void AddData(const char *Field, float Value);
    void AddData(const char *Field, double Value);
    void AddData(const char *Field, char Value);
