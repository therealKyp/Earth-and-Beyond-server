...
bool ItemBaseParser::LoadItemBase(ItemBase ** GlobalDB)
{
	...
	const char * m_DamageType[] = {"Impact", "Explosive", "Plasma", "Energy", "Emp", "Chemical", "Absolute", "System", "Effect"};
	...
	for(int item=0;item<ItemList_result->n_rows();item++)
	{
		...
		m_Data->Description = g_StringMgr->GetStr(ItemList_Data["description"]);
		m_Data->Manufacturer = g_StringMgr->GetStr(ItemList_Data["item_manufacturer_base.name"]);
		m_Data->Name = g_StringMgr->GetStr(ItemList_Data["name"]);
			...
			case 16:
				{
					...
					if (Item_result && Item_result->n_rows() > 0)
					{
						...
						m_Data->ItemFields[1].sData = g_StringMgr->GetStr( Item_Data["item_ammo_type.name"]);
			...
			if (Effect_List_result && Effect_List_result->n_rows() > 0)
			{
				for(int eff=0;eff<Effect_List_result->n_rows();eff++)
				{
					...
					if (EffectType == 1)
					{
						...
						m_Data->ActivatableEffects.Effects[AEffectCount-1].Description = g_StringMgr->GetStr(Effect_List_Data["Description"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].Tooltip = g_StringMgr->GetStr(Effect_List_Data["Tooltip"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].Name = g_StringMgr->GetStr(Effect_List_Data["Name"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].BuffName = g_StringMgr->GetStr(Effect_List_Data["Buff_Name"]);
						...
						// Varables
						m_Data->ActivatableEffects.Effects[AEffectCount-1].VarStats[0] = g_StringMgr->GetStr(Effect_List_Data["Var1Stat"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].VarStats[1] = g_StringMgr->GetStr(Effect_List_Data["Var2Stat"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].VarStats[2] = g_StringMgr->GetStr(Effect_List_Data["Var3Stat"]);
						...
						// Constants
						m_Data->ActivatableEffects.Effects[AEffectCount-1].ConstStats[0] = g_StringMgr->GetStr(Effect_List_Data["Constant1Stat"]);
						m_Data->ActivatableEffects.Effects[AEffectCount-1].ConstStats[1] = g_StringMgr->GetStr(Effect_List_Data["Constant2Stat"]);
					...
					else
					{
						...
						m_Data->EquipableEffects.Effects[EEffectCount-1].Description = g_StringMgr->GetStr(Effect_List_Data["Description"]);
						m_Data->EquipableEffects.Effects[EEffectCount-1].Tooltip = g_StringMgr->GetStr(Effect_List_Data["Tooltip"]);
						m_Data->EquipableEffects.Effects[EEffectCount-1].Name = g_StringMgr->GetStr(Effect_List_Data["Name"]);
						...
						// Varables
						m_Data->EquipableEffects.Effects[EEffectCount-1].VarStats[0] = g_StringMgr->GetStr(Effect_List_Data["Var1Stat"]);
						m_Data->EquipableEffects.Effects[EEffectCount-1].VarStats[1] = g_StringMgr->GetStr(Effect_List_Data["Var2Stat"]);
						m_Data->EquipableEffects.Effects[EEffectCount-1].VarStats[2] = g_StringMgr->GetStr(Effect_List_Data["Var3Stat"]);
						...
						// Constants
						m_Data->EquipableEffects.Effects[EEffectCount-1].ConstStats[0] = g_StringMgr->GetStr(Effect_List_Data["Constant1Stat"]);
						m_Data->EquipableEffects.Effects[EEffectCount-1].ConstStats[1] = g_StringMgr->GetStr(Effect_List_Data["Constant2Stat"]);
