...
{
    class ItemBeamRecordManager : IRecordManager
    {
        private IGui m_gui;
        ...
        public DataValidation.Result validField(Boolean newRecord, DataBinding dataBinding, DataRow dataRow)
        {
            ...
            /*switch ((Net7_db.Table_item_ammo)dataBinding.enumeration)
            {
            }*/
        ...
        {
            Net7.Table_item_beam beamField = (Net7.Table_item_beam)dataBinding.enumeration;
            switch (beamField)
            {
                case Net7.Table_item_beam._rest_race:
                case Net7.Table_item_beam._rest_prof:
                    // Handles both race and profession restrictions
                    return Restrictions.updateField(newRecord, dataRow, Net7.Table_item_beam._rest_race, Net7.Table_item_beam._rest_prof);
            }
            return false;
        }
