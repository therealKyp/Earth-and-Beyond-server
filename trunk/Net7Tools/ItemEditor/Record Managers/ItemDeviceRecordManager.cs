...
{
    class ItemDeviceRecordManager : IRecordManager
    {
        private IGui m_gui;
        ...
        public Boolean displayField(DataBinding dataBinding, DataRow dataRow)
        {
            switch ((Net7.Table_item_device)dataBinding.enumeration)
            {
                ...
                case Net7.Table_item_device._rest_prof:
                    ...
                    return Restrictions.displayField(dataRow, Net7.Table_item_device._rest_race, Net7.Table_item_device._rest_prof);
                case Net7.Table_item_device._energy_100:
                    dataBinding.control.Text = (dataRow == null) ? "100" : ColumnData.GetString(dataRow, dataBinding.enumeration);
                    return true;
                case Net7.Table_item_device._range_100:
        ...
        public String selectDataRowFromId(String currentId)
        {
            return " SELECT * FROM "
                 ...
                 + " WHERE "
                 + ColumnData.GetName(Net7.Table_item_device._item_id)
                 + " = "
                 + currentId;
        }
