...
namespace N7.Sprites
{
    class DecorationSprite
    {
        ...
        private void setupData(DataRow r)
        {
            ...
            //Create a new Property window and add populate it.
            dp = new BaseProps();
        ...
        public void updateChangedInfo(String propertyName, Object _changedValue)
        {
            ...
            else if (propertyName == "Signature")
            {
                ...
                decorationImage.GetChild(0).X = (x+(imageWidth/2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(0).Y = (y+(imageHeight/2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(0).Width = (float.Parse(changedValue) * 2) / 100;
                decorationImage.GetChild(0).Height = (float.Parse(changedValue) * 2) / 100;
            }
            ...
            else if (propertyName == "ExplorationRange")
            {
                ...
                float x = decorationImage.X;
                float y = decorationImage.Y;
                decorationImage.GetChild(2).X = (x + (imageWidth / 2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(2).Y = (y + (imageHeight / 2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(2).Width = (float.Parse(changedValue) * 2) / 100;
                decorationImage.GetChild(2).Height = (float.Parse(changedValue) * 2) / 100;
            }
            ...
            else if (propertyName == "Name")
            {
                ...
                float x = decorationImage.X;
                float y = decorationImage.Y;
                PText name = (PText) decorationImage.GetChild(3);
            ...
            else if (propertyName == "RadarRange")
            {
                ...
                float x = decorationImage.X;
                float y = decorationImage.Y;
                decorationImage.GetChild(1).X = (x + (imageWidth / 2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(1).Y = (y + (imageHeight / 2)) - (float.Parse(changedValue) / 100);
                decorationImage.GetChild(1).Width = (float.Parse(changedValue) * 2) / 100;
                decorationImage.GetChild(1).Height = (float.Parse(changedValue) * 2) / 100;
            }
