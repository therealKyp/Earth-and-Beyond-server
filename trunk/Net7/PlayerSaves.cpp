...
void Player::CreatePositionSave()
{
	...
	sprintf(query_str, "DELETE FROM `avatar_position` WHERE `avatar_id` = '%d'", m_CharacterID);
...
bool Player::LoadPosition()
{
	...
	sprintf(query_str, "SELECT * FROM `avatar_position` WHERE `avatar_id` = '%d'", m_CharacterID);
...
bool Player::ReadSavedData()
{
	...
	sql_query_c account_query (&connection);
	...
	sprintf(query_str, "SELECT * FROM `avatar_level_info` WHERE `avatar_id` = '%d'", m_CharacterID);
...
/*---------------------------------------------------------------------*/
	...
	sprintf(query_str, "SELECT * FROM `avatar_equipment` WHERE `avatar_id` = '%d'", m_CharacterID);
	...
	sprintf(query_str, "SELECT * FROM `avatar_ammo` WHERE `avatar_id` = '%d'", m_CharacterID);
	...
	sprintf(query_str, "SELECT * FROM `avatar_inventory_items` WHERE `avatar_id` = '%d'", m_CharacterID);
	...
	sprintf(query_str, "SELECT * FROM `avatar_vault_items` WHERE `avatar_id` = '%d'", m_CharacterID);
	...
	sprintf(query_str, "SELECT * FROM `avatar_skill_levels` WHERE `avatar_id` = '%d'", m_CharacterID);
...
void Player::LoadExploredNavs(sql_query_c *query)
{
	...
	sprintf(query_str, "SELECT * FROM `avatar_exploration` WHERE `avatar_id` = '%d'", m_CharacterID);
...
void Player::SetupFactions(sql_query_c *query, bool force)
{
	...
	if (!force)
	{
		sprintf(query_str, "SELECT * FROM `faction_data` WHERE `avatar_id` = '%d'", m_CharacterID);
		query->run_query(query_str);
		query->store(&account_result);
	}
	...
	else
	{
		for(i=0;i<account_result.n_rows();i++)
		{
			...
			PlayerIndex()->Reputation.Factions.Faction[i].SetName( g_ServerMgr->m_FactionData.GetFactionPDAName(faction_id) );
...
void Player::LoadMissionStatus(sql_query_c *query)
{
	...
	sprintf(query_str, "SELECT * FROM `avatar_mission_progress` WHERE `avatar_id` = '%d'", m_CharacterID);
...
bool Player::CheckMissionCompleted(long mission_id)
{
	...
	sprintf(query_str, "SELECT * FROM net7_user.missions_completed WHERE avatar_id = '%d' AND mission_id = '%d'", m_CharacterID, mission_id);
...
void Player::DeleteAllAvatarRecords()
{
	...
	sprintf(query_str, "DELETE FROM `avatar_ammo` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_equipment` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_faction_level` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_inventory_items` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_mission_progress` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_skill_levels` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_vault_items` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `missions_completed` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `avatar_exploration` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);

	sprintf(query_str, "DELETE FROM `faction_data` WHERE `avatar_id` = '%d'", m_CharacterID);
	account_query.run_query(query_str);
}
