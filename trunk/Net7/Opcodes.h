...
//this is used for UDP packet re-sends, it is from the connection resend queue to the player's input queue
#define ENB_OPCODE_4000_RESEND_PACKET_SEQUENCE			0x4000
